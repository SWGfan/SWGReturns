...
void ShipObject::scheduleRecovery() {
	ShipObjectImplementation* _implementation = static_cast<ShipObjectImplementation*>(_getImplementation());
	if (unlikely(_implementation == NULL)) {
		if (!deployed)
			throw ObjectNotDeployedException(this);

		DistributedMethod method(this, RPC_SCHEDULERECOVERY__);

		method.executeWithVoidReturn();
	} else {
		assert(this->isLockedByCurrentThread());
		_implementation->scheduleRecovery();
	}
}

void ShipObject::cancelRecovery() {
	ShipObjectImplementation* _implementation = static_cast<ShipObjectImplementation*>(_getImplementation());
	if (unlikely(_implementation == NULL)) {
		if (!deployed)
			throw ObjectNotDeployedException(this);

		DistributedMethod method(this, RPC_CANCELRECOVERY__);

		method.executeWithVoidReturn();
	} else {
		assert(this->isLockedByCurrentThread());
		_implementation->cancelRecovery();
	}
}
...
void ShipObject::notifyDespawn(Zone* zone) {
	ShipObjectImplementation* _implementation = static_cast<ShipObjectImplementation*>(_getImplementation());
	if (unlikely(_implementation == NULL)) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
...
void ShipObject::updatePlayersInShip(bool lightUpdate, bool sendPackets) {
	ShipObjectImplementation* _implementation = static_cast<ShipObjectImplementation*>(_getImplementation());
	if (unlikely(_implementation == NULL)) {
		if (!deployed)
			throw ObjectNotDeployedException(this);

		DistributedMethod method(this, RPC_UPDATEPLAYERSINSHIP__BOOL_BOOL_);
		method.addBooleanParameter(lightUpdate);
		method.addBooleanParameter(sendPackets);

		method.executeWithVoidReturn();
	} else {
		_implementation->updatePlayersInShip(lightUpdate, sendPackets);
	}
}
...
bool ShipObject::isHyperspacing() {
	ShipObjectImplementation* _implementation = static_cast<ShipObjectImplementation*>(_getImplementationForRead());
	if (unlikely(_implementation == NULL)) {
		if (!deployed)
			throw ObjectNotDeployedException(this);
...
void ShipObject::initializeUniqueID(bool notifyClient) {
	...
	if (unlikely(_implementation == NULL)) {
		...
		DistributedMethod method(this, RPC_INITIALIZEUNIQUEID__BOOL_);
		method.addBooleanParameter(notifyClient);
...
bool ShipObjectImplementation::isHyperspacing() {
	// server/zone/objects/ship/ShipObject.idl():  		return hyperspacing;
	return hyperspacing;
}

bool ShipObjectImplementation::hasShipWings() {
...
void ShipObjectAdapter::invokeMethod(uint32 methid, DistributedMethod* inv) {
	...
	case RPC_NOTIFYINSERTTOZONE__ZONE_:
		...
		break;
	case RPC_UPDATEPLAYERSINSHIP__BOOL_BOOL_:
		{
	...
	case RPC_RESETEFFICIENCY__:
		...
		break;
	case RPC_INITIALIZEUNIQUEID__BOOL_:
		{
			bool notifyClient = inv->getBooleanParameter();
			
			initializeUniqueID(notifyClient);
...
void ShipObjectAdapter::scheduleRecovery() {
	(static_cast<ShipObject*>(stub))->scheduleRecovery();
}

void ShipObjectAdapter::cancelRecovery() {
	(static_cast<ShipObject*>(stub))->cancelRecovery();
}
...
void ShipObjectAdapter::notifyDespawn(Zone* zone) {
	(static_cast<ShipObject*>(stub))->notifyDespawn(zone);
}
...
void ShipObjectAdapter::notifyInsertToZone(Zone* zone) {
	(static_cast<ShipObject*>(stub))->notifyInsertToZone(zone);
}

void ShipObjectAdapter::updatePlayersInShip(bool lightUpdate, bool sendPackets) {
	(static_cast<ShipObject*>(stub))->updatePlayersInShip(lightUpdate, sendPackets);
}
...
bool ShipObjectAdapter::isHyperspacing() {
	return (static_cast<ShipObject*>(stub))->isHyperspacing();
}

bool ShipObjectAdapter::hasShipWings() {
...
void ShipObjectAdapter::initializeUniqueID(bool notifyClient) {
	(static_cast<ShipObject*>(stub))->initializeUniqueID(notifyClient);
}
