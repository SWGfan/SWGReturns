...
void AiAgent::setFormationOffset(float forward, float right) {
	AiAgentImplementation* _implementation = static_cast<AiAgentImplementation*>(_getImplementation());
	if (unlikely(_implementation == NULL)) {
		if (!deployed)
			throw ObjectNotDeployedException(this);

		DistributedMethod method(this, RPC_SETFORMATIONOFFSET__FLOAT_FLOAT_);
		method.addFloatParameter(forward);
		method.addFloatParameter(right);

		method.executeWithVoidReturn();
	} else {
		_implementation->setFormationOffset(forward, right);
	}
}

void AiAgent::clearFormationOffset() {
	AiAgentImplementation* _implementation = static_cast<AiAgentImplementation*>(_getImplementation());
	if (unlikely(_implementation == NULL)) {
		if (!deployed)
			throw ObjectNotDeployedException(this);

		DistributedMethod method(this, RPC_CLEARFORMATIONOFFSET__);

		method.executeWithVoidReturn();
	} else {
		_implementation->clearFormationOffset();
	}
}

float AiAgent::getFormationOffsetForward() {
	AiAgentImplementation* _implementation = static_cast<AiAgentImplementation*>(_getImplementation());
	if (unlikely(_implementation == NULL)) {
		if (!deployed)
			throw ObjectNotDeployedException(this);

		DistributedMethod method(this, RPC_GETFORMATIONOFFSETFORWARD__);

		return method.executeWithFloatReturn();
	} else {
		return _implementation->getFormationOffsetForward();
	}
}

float AiAgent::getFormationOffsetRight() {
	AiAgentImplementation* _implementation = static_cast<AiAgentImplementation*>(_getImplementation());
	if (unlikely(_implementation == NULL)) {
		if (!deployed)
			throw ObjectNotDeployedException(this);

		DistributedMethod method(this, RPC_GETFORMATIONOFFSETRIGHT__);

		return method.executeWithFloatReturn();
	} else {
		return _implementation->getFormationOffsetRight();
	}
}
...
void AiAgentImplementation::setFormationOffset(float forward, float right) {
	// server/zone/objects/creature/ai/AiAgent.idl():  		formationOffsetForward = forward;
	formationOffsetForward = forward;
	// server/zone/objects/creature/ai/AiAgent.idl():  		formationOffsetRight = right;
	formationOffsetRight = right;
}

void AiAgentImplementation::clearFormationOffset() {
	// server/zone/objects/creature/ai/AiAgent.idl():  		formationOffsetForward = 0.f;
	formationOffsetForward = 0.f;
	// server/zone/objects/creature/ai/AiAgent.idl():  		formationOffsetRight = 0.f;
	formationOffsetRight = 0.f;
}

float AiAgentImplementation::getFormationOffsetForward() {
	// server/zone/objects/creature/ai/AiAgent.idl():  		return formationOffsetForward;
	return formationOffsetForward;
}

float AiAgentImplementation::getFormationOffsetRight() {
	// server/zone/objects/creature/ai/AiAgent.idl():  		return formationOffsetRight;
	return formationOffsetRight;
}
...
void AiAgentAdapter::invokeMethod(uint32 methid, DistributedMethod* inv) {
	...
	case RPC_STOREFOLLOWOBJECT__:
		...
		break;
	case RPC_SETFORMATIONOFFSET__FLOAT_FLOAT_:
		{
			float forward = inv->getFloatParameter();
			float right = inv->getFloatParameter();
			
			setFormationOffset(forward, right);
			
		}
		break;
	case RPC_CLEARFORMATIONOFFSET__:
		{
			
			clearFormationOffset();
			
		}
		break;
	case RPC_GETFORMATIONOFFSETFORWARD__:
		{
			
			float _m_res = getFormationOffsetForward();
			resp->insertFloat(_m_res);
		}
		break;
	case RPC_GETFORMATIONOFFSETRIGHT__:
		{
			
			float _m_res = getFormationOffsetRight();
			resp->insertFloat(_m_res);
		}
		break;
...
void AiAgentAdapter::setFormationOffset(float forward, float right) {
	(static_cast<AiAgent*>(stub))->setFormationOffset(forward, right);
}

void AiAgentAdapter::clearFormationOffset() {
	(static_cast<AiAgent*>(stub))->clearFormationOffset();
}

float AiAgentAdapter::getFormationOffsetForward() {
	return (static_cast<AiAgent*>(stub))->getFormationOffsetForward();
}

float AiAgentAdapter::getFormationOffsetRight() {
	return (static_cast<AiAgent*>(stub))->getFormationOffsetRight();
}
