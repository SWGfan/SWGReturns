...
bool SceneObject::isCompanionControlDevice() {
	SceneObjectImplementation* _implementation = static_cast<SceneObjectImplementation*>(_getImplementationForRead());
	if (unlikely(_implementation == NULL)) {
		if (!deployed)
			throw ObjectNotDeployedException(this);

		DistributedMethod method(this, RPC_ISCOMPANIONCONTROLDEVICE__);

		return method.executeWithBooleanReturn();
	} else {
		return _implementation->isCompanionControlDevice();
	}
}
...
bool SceneObject::isCompanionObject() const {
	SceneObjectImplementation* _implementation = static_cast<SceneObjectImplementation*>(_getImplementationForRead());
	if (unlikely(_implementation == NULL)) {
		if (!deployed)
			throw ObjectNotDeployedException(this);

		DistributedMethod method(this, RPC_ISCOMPANIONOBJECT__);

		return method.executeWithBooleanReturn();
	} else {
		return _implementation->isCompanionObject();
	}
}
...
bool SceneObjectImplementation::isDetector() const{
	...
	return (&dataObjectComponent)->get() != NULL && (&dataObjectComponent)->get()->isDetectorData();
}
...
bool SceneObjectImplementation::isForceNoTrade() const{
	// server/zone/objects/scene/SceneObject.idl():  		return forceNoTrade;
	return forceNoTrade;
}
...
bool SceneObjectImplementation::isCompanionControlDevice() {
	// server/zone/objects/scene/SceneObject.idl():  		return false;
	return false;
}
...
bool SceneObjectImplementation::isCompanionObject() const{
	// server/zone/objects/scene/SceneObject.idl():  		return false;
	return false;
}
...
void SceneObjectAdapter::invokeMethod(uint32 methid, DistributedMethod* inv) {
	...
	case RPC_ISPETCONTROLDEVICE__:
		...
		break;
	case RPC_ISCOMPANIONCONTROLDEVICE__:
		{
			
			bool _m_res = isCompanionControlDevice();
			resp->insertBoolean(_m_res);
		}
		break;
	...
	case RPC_ISPET__:
		...
		break;
	case RPC_ISCOMPANIONOBJECT__:
		{
			
			bool _m_res = isCompanionObject();
			resp->insertBoolean(_m_res);
		}
		break;
	case RPC_ISMOUNT__:
...
bool SceneObjectAdapter::isCompanionControlDevice() {
	return (static_cast<SceneObject*>(stub))->isCompanionControlDevice();
}
...
bool SceneObjectAdapter::isCompanionObject() const {
	return (static_cast<SceneObject*>(stub))->isCompanionObject();
}
