...
// FIX: INVULNERABLE is not in OptionBitmask in Core3.
// Use the DestructibleBuildingDataComponent definition (or another correct source).
...
ShipAgentTemplateManager::ShipAgentTemplateManager() : Logger("ShipAgentTemplateManager") {
	...
	// core3: INVULNERABLE isn't defined in OptionBitmask; use DestructibleBuildingDataComponent constant
	lua->setGlobalInt("INVULNERABLE",               DestructibleBuildingDataComponent::INVULNERABLE);
