...
int CreatureTemplateManager::checkArgumentCount(lua_State* L, int args) {
    ...
    if (parameterCount < args) return 1;
    if (parameterCount > args) return 2;
    return 0;
}

int CreatureTemplateManager::includeFile(lua_State* L) {
    if (checkArgumentCount(L, 1) == 1) {
        instance()->error("incorrect number of arguments passed to includeFile");
...
int CreatureTemplateManager::addTemplate(lua_State* L) {
    if (checkArgumentCount(L, 2) == 1) {
        instance()->error("incorrect number of arguments passed to addTemplate");
        ERROR_CODE = INCORRECT_ARGUMENTS;
        return 0;
    }
...
int CreatureTemplateManager::addConversationTemplate(lua_State* L) {
    if (checkArgumentCount(L, 2) == 1) {
        instance()->error("incorrect number of arguments passed to addConversationTemplate");
        ERROR_CODE = INCORRECT_ARGUMENTS;
        return 0;
    }
...
int CreatureTemplateManager::addWeapon(lua_State* L) {
    if (checkArgumentCount(L, 2) == 1) {
        instance()->error("incorrect number of arguments passed to addWeapon");
        ERROR_CODE = INCORRECT_ARGUMENTS;
        return 0;
    }
...
int CreatureTemplateManager::addSpawnGroup(lua_State* L) {
    if (checkArgumentCount(L, 2) == 1) {
        instance()->error("incorrect number of arguments passed to addSpawnGroup");
        ERROR_CODE = INCORRECT_ARGUMENTS;
        return 0;
    }
...
int CreatureTemplateManager::addLairTemplate(lua_State* L) {
    if (checkArgumentCount(L, 2) == 1) {
        instance()->error("incorrect number of arguments passed to addLairTemplate");
        ERROR_CODE = INCORRECT_ARGUMENTS;
        return 0;
    }
...
int CreatureTemplateManager::addDestroyMissionGroup(lua_State* L) {
    if (checkArgumentCount(L, 2) == 1) {
        instance()->error("incorrect number of arguments passed to addDestroyMissionGroup");
        ERROR_CODE = INCORRECT_ARGUMENTS;
        return 0;
    }
...
int CreatureTemplateManager::addPatrolPathTemplate(lua_State* L) {
    if (checkArgumentCount(L, 2) == 1) {
        instance()->error("incorrect number of arguments passed to addPatrolPathTemplate");
        ERROR_CODE = INCORRECT_ARGUMENTS;
        return 0;
    }
...
int CreatureTemplateManager::addOutfitGroup(lua_State* L) {
    if (checkArgumentCount(L, 2) == 1) {
        instance()->error("incorrect number of arguments passed to addOutfitGroup");
        ERROR_CODE = INCORRECT_ARGUMENTS;
        return 0;
    }
...
int CreatureTemplateManager::addDressGroup(lua_State* L) {
    if (checkArgumentCount(L, 2) == 1) {
        instance()->error("incorrect number of arguments passed to addDressGroup");
        ERROR_CODE = INCORRECT_ARGUMENTS;
        return 0;
    }
