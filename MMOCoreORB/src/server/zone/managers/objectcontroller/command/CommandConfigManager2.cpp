...
void CommandConfigManager::registerCommands2() {
	...
	// Companion System (2026-08-07, batch 14/15/17 follow-up) -- the 142
	// abilities added to build_command_table_rows.py's/build_ui_styles_patch.py's
	// _COMPANION_ABILITY_NAMES (full combat-tree icon coverage pass) got their
	// command_table.iff row + cmd_n.stf name + ui_styles icon that day, but were
	// never actually registered with the command factory -- so the ability
	// existed and could show an icon, but issuing it did nothing (unregistered
	// command name). Live report: "if my companion has novice marksman i should
	// be able to use those commands to my companion shoots off that certain
	// ability." Closing that gap here.
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionactionshot1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionactionshot2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionaim").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionberserk2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionbodyshot1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionbodyshot2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionbodyshot3").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionboostmorale").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionburstshot1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionburstshot2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionchargeshot1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionchargeshot2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companioncripplingshot").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companioncuredisease").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companioncurepoison").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companiondazzle").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companiondisarmingshot1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companiondisarmingshot2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companiondiveshot").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companiondoubletap").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companiondragincapacitatedplayer").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionextinguishfire").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionfanshot").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionfeigndeath").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionfirstaid").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionforage").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionforceofwill").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionfullautoarea1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionfullautoarea2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionfullautosingle1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionfullautosingle2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionheadshot1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionheadshot2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionhealenhance").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionhealstate").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionhealthshot1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionhealthshot2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionintimidate2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionkipupshot").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionlastditch").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionlegshot1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionlegshot2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionlegshot3").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionlowblow").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmaskscent").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmeditate").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmelee1hblindhit1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmelee1hblindhit2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmelee1hbodyhit1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmelee1hbodyhit2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmelee1hbodyhit3").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmelee1hdizzyhit1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmelee1hdizzyhit2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmelee1hhealthhit1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmelee1hhealthhit2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmelee1hhit1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmelee1hhit2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmelee1hhit3").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmelee1hlunge2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmelee1hscatterhit1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmelee1hscatterhit2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmelee1hspinattack1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmelee1hspinattack2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmelee2harea1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmelee2harea2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmelee2harea3").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmelee2hheadhit1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmelee2hheadhit2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmelee2hheadhit3").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmelee2hhit1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmelee2hhit2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmelee2hhit3").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmelee2hlunge2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmelee2hmindhit1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmelee2hmindhit2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmelee2hspinattack1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmelee2hspinattack2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmelee2hsweep1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmelee2hsweep2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmindshot1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionmultitargetpistolshot").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionoverchargeshot2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionpanicshot").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionpistolmeleedefense1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionpistolmeleedefense2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionpointblankarea2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionpointblanksingle2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionpolearmactionhit1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionpolearmactionhit2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionpolearmarea1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionpolearmarea2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionpolearmhit1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionpolearmhit2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionpolearmhit3").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionpolearmleghit1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionpolearmleghit2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionpolearmleghit3").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionpolearmlunge2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionpolearmspinattack1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionpolearmspinattack2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionpolearmstun1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionpolearmstun2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionpolearmsweep1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionpolearmsweep2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionpowerboost").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionquickheal").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionrally").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionretreat").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionreviveplayer").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionrollshot").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionscattershot1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionscattershot2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionsteadyaim").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionstoppingshot").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionsuppressionfire1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionsuppressionfire2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companiontakecover").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionthreatenshot").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companiontumbletokneeling").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companiontumbletoprone").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companiontumbletostanding").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionunarmedblind1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionunarmedbodyhit1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionunarmedcombo1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionunarmedcombo2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionunarmeddizzy1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionunarmedheadhit1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionunarmedhit1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionunarmedhit2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionunarmedhit3").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionunarmedknockdown1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionunarmedknockdown2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionunarmedleghit1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionunarmedlunge2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionunarmedspinattack1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionunarmedspinattack2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionunarmedstun1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionvolleyfire").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionwarcry2").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionwarningshot").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionwildshot1").toLowerCase());
	commandFactory.registerCommand<CompanionAbilityCommand>(String("companionwildshot2").toLowerCase());
