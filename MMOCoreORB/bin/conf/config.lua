...
Core3 = {
	...
	DBName = "genesis",
	DBUser = "swgemu",
	DBPass = "fsUwFWt4zYxIPDLcAFgodRNz4GbD",
	DBInstances = 2,
	DBSecret = "WooT7T2uSLQYYCPrA0HHX5vPVdav8dQ6", -- Change this! This value should be unique and of reasonable length.
	...
	MantisName = "swgemu",
	MantisUser = "swgemu",
	MantisPass = "fsUwFWt4zYxIPDLcAFgodRNz4GbD",
	...
	LogFileLevel = 5, -- -1 NONE, 0 FATAL, 1 ERROR, 2 WARNING, 3 LOG, 4 INFO, 5 DEBUG
