event_lewt_box_01 = {
    ...
    lootItems = {
        ...
        {groupTemplate = "g_baton_stun_legendary", weight = 625000},
        {groupTemplate = "g_lance_nightsister_legendary", weight = 625000},
    }
}

addLootGroupTemplate("event_lewt_box_01", event_lewt_box_01)
