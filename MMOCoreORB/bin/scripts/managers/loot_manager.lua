...
-- Global loot table roll multiplier.
-- 1.00 = default
-- 1.80 = 80% higher chance for loot collection entries to fire
--globalLootChanceMultiplier = 1.80
...
randomDotStrength = {50, 2000} -- Set for disease. Fire will be x1.5, poison x2.
randomDotDuration = {80, 2400} -- Set for poison. Fire will be x1.5, disease x5.
randomDotPotency = {10, 1000}
randomDotUses = {250, 99999}
