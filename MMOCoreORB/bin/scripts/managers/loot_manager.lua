...
--Global multipliers applied on top of every creature's own loot table (for now, testing).
globalLootChanceMultiplier = 3.0 -- multiplies the chance ANY loot group entry drops at all
globalLootCreditsMultiplier = 3.0 -- multiplies credits awarded from loot
