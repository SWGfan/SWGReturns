...
--Cheap Buffs
cheapPerformanceBuff = 1500
cheapMedicalBuff = 1500

--Expensive Buffs
expensivePerformanceBuff = 3200
expensivePerformanceSubBuff = 3200
expensiveMedicalBuff = 3200
expensiveMedicalSubBuff = 3200
...
-----------------------------------
veteranRewardMilestones = {0, 60, 90, 120, 150, 180, 310, 340, 370, 400, 430, 460} --days, must be sorted low to high

veteranRewardAdditionalMilestones = 0 --frequency, in days, of additional milestones (beyond the established ones)
