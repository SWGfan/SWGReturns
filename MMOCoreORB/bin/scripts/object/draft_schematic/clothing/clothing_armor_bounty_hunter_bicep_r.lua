...
object_draft_schematic_clothing_clothing_armor_bounty_hunter_bicep_r = object_draft_schematic_clothing_shared_clothing_armor_bounty_hunter_bicep_r:new {
  templateType = DRAFTSCHEMATIC,
   ...
   resourceTypes = {"ore_intrusive", "fuel_petrochem_solid_known", "fiberplast", "aluminum", "copper_beyrllius", "hide_wooly", "object/tangible/component/armor/shared_armor_segment_ris.iff", "object/tangible/component/clothing/shared_synthetic_cloth.iff", "object/tangible/component/clothing/shared_reinforced_fiber_panels.iff"},
