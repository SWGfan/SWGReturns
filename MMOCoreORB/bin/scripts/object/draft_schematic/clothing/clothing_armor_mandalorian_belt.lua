...
object_draft_schematic_clothing_clothing_armor_mandalorian_belt = object_draft_schematic_clothing_shared_clothing_armor_mandalorian_belt:new {
   ...
   resourceTypes = {"hide_leathery_lok", "hide_scaley", "fiberplast_corellia", "metal", "petrochem_inert_polymer", "hide_wooly", "object/tangible/component/armor/shared_armor_segment_ris.iff", "object/tangible/component/clothing/shared_synthetic_cloth.iff", "object/tangible/loot/dungeon/death_watch_bunker/shared_emulsion_protection.iff"},
