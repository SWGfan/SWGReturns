...
function DathomirStaticSpawnsSwScreenPlay:spawnMobiles()
	...
	-- nightsister vibroblade camp (-3050,-980)
spawnMobile("dathomir", "nightsister_vibroblade_initiate", 360, -3055.2, 141.0, -978.4, 45, 0)
spawnMobile("dathomir", "nightsister_vibroblade_initiate", 360, -3042.8, 140.5, -985.1, -90, 0)
spawnMobile("dathomir", "nightsister_vibroblade_warrior", 360, -3048.6, 141.2, -972.3, 120, 0)
spawnMobile("dathomir", "nightsister_vibroblade_warrior", 360, -3061.4, 141.5, -991.6, -45, 0)
spawnMobile("dathomir", "nightsister_vibroblade_elder", 420, -3052.0, 141.8, -982.0, 180, 0)
