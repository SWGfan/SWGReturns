...
includeFile("spawn/florrum_world.lua")
includeFile("spawn/destroy_mission/florrum_destroy_missions.lua")
includeFile("spawn/lothal_world.lua")
includeFile("spawn/loth_cats.lua")
includeFile("spawn/destroy_mission/lothal_destroy_missions.lua")
-- Mustafar
