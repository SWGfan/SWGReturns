saxon_clan_commander = Creature:new {
	customName = "Saxon Commander",
	...
	lootGroups = {
		{
				groups = {
					...
					{group = "rebel_pack",  chance = 250000},
					{group = "rebel_crusade",  chance = 250000}
				},
				lootChance = 8000000
			}
		},
...
CreatureTemplates:addCreatureTemplate(saxon_clan_commander, "saxon_clan_commander")
