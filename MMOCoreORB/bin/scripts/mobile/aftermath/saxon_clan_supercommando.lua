saxon_clan_supercommando = Creature:new {
	customName, "Saxon Supercommando",
...
CreatureTemplates:addCreatureTemplate(saxon_clan_supercommando, "saxon_clan_supercommando")
