	...
	lootGroups = {
		{
			groups = {
				...
				{group = "tusken_common", chance = 2920000},
				{group = "wearables_scarce", chance = 1920000},
				{group = "bone_armor", chance = 670000},
				{group = "chitin_armor", chance = 670000},
				...
				{group = "house_loot_schems", chance = 20000}
			}
		}
	},
