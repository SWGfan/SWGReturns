...
COMPANION_STF_ENTRIES = [
    ...
    ("missing_master_badge", "You must have earned this profession's Master Badge to train your companion in it."),
    ...
    ("companion_granted", "A companion has been added to your datapad. Use it to call your companion out whenever you like."),
